...
const StudentSidebar: React.FC = () => {
  ...
  const menuItems = [
    { id: "dashboard", label: "Dashboard", icon: BarChart3, path: "/student/dashboard" },
    { id: "upload", label: "Upload Documents", icon: FileText, path: "/upload-seating-plan" },
          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                } px-4 py-3 rounded-lg text-left transition-all duration-200 relative group ${
                  isActive
        ...
        <div className={`flex items-center ${isCollapsed ? "justify-center" : ""}`}>
          ...
          {!isCollapsed && (
            <div className="ml-3 overflow-hidden">
              <div className="text-white font-medium text-sm whitespace-nowrap">Student User</div>
              <div className="text-gray-400 text-xs whitespace-nowrap">Student</div>
            </div>
          )}
        </div>
      </div>
