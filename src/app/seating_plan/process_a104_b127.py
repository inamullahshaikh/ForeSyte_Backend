#!/usr/bin/env python3
"""
Draw Seat Maps for A104 and B127
Interactive polygon drawing tool for rooms A104-25112025 and B127-25112025
"""
...
def process_room(room_folder: Path, load_existing: bool = True):
    ...
    Args:
        room_folder: Path to room folder (e.g., A104-25112025)
...
def main():
    ...
    print("\n" + "="*70)
    print("DRAWING SEAT MAPS: A104 and B127")
    print("="*70)
